...
// with lightmap
float4 Terrain7LmPS(inTerrainPS In) : COLOR0
{
	//----------------------------------------------------------
	// color
...
// without lightmap
float4 Terrain7PS(inTerrainPS In) : COLOR0
{
	//----------------------------------------------------------
	// color
...
//		cullmode = none;
	   ...
	   AlphaBlendEnable 	= False;
		...
		PixelShader  = compile ps_3_0 Terrain7PS();
	}
}
...
//		cullmode = none;
	   ...
	   AlphaBlendEnable 	= False;
		...
		VertexShader = compile vs_3_0 TerrainVS();
		PixelShader  = compile ps_3_0 Terrain7LmPS();
	}
}