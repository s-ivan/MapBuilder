...
#ifndef MBsaveaswmb_h
#define MBsaveaswmb_h


#define USE_DIALOG		// in this case terrain should be in MB.exe folder

//#include <stdio.h>

//int		saveaswmb_total_ents = 1000;	// variable needed for progress bar, can't be 0 ! - or use num_entities
...
#define writetab file_asc_write(wmb_handle,9)
...
void		SaveWmb_Save_Wmb(STRING* filename_str);
