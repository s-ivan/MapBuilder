   ...
   //----------------------------------------------------------------   
	...
	if (InPos.y > vecSkill41.w ) 										
	{
	   ...
	   // position animation
		...
		float speed = sin( (vecTime.w+0.2*(PosWorld.x+PosWorld.y+PosWorld.z)) * 0.020 );	//DoDefault(vecSkill41.z*(0.05/50),0.05)
