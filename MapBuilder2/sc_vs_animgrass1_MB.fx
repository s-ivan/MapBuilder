	...
	if (InPos.y > 0.25f ) 																										// needed by sprites where vertices are undefined										
		{
			...
			float speed = sin( (vecTime.w + 0.2f * (PosWorld.x + PosWorld.y + PosWorld.z)) * 0.03 );		// was DoDefault(vecSkill41.z*(0.05/50),0.05)
