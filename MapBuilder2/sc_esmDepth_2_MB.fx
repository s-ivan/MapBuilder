...
// for 64x1 sprite animation shader
...
//	Output.Color = 1;	
	...
	float2 Tile = 0;
	Tile.x = frac(PSIn.Tex.x * vecSkill41.y + floor(vecSkill41.x) * vecSkill41.y);				// x frame 0..63, 			y unit-width, 			frac for safety				fram is fine with floor(vecTime.w)
	Tile.y = PSIn.Tex.y;
		
	Output.Color.w = tex2D(colorSampler, Tile).a;
